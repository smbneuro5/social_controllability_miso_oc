...
%% Trial 6-35
for i = 1:nP        
    % trials = find(A_miso(i).IC.R.xR>5 & A(i).IC.R.xR<36); R and xR not in
    % file
    
    OFFER{i,1} = A(i).IC.offer;
    RESP{i,1} = A(i).IC.choice;    
end

% Where the model scripts are
addpath(genpath('/Users/sarahbanker/Documents/SinaiYear3/UG_Analysis/2.model'));


% Where to save the results
cd('/Users/sarahbanker/Documents/SinaiYear3/UG_Analysis/');
